function typeWatch(sDivInput)
{
	//$("#" + sDivInput + "").before('<input type="text" name="'+sDivInput+'_mask" id="' + sDivInput + '_mask" value="0">').hide();
	$("#" + sDivInput).keyup(function(){											  
		var str = $(this).val();
		if (str.charAt(0) >= 0)
		{
			var n = str.length;
...
function ValidateAndFormatNumber(NumberTextBox)
{
    ...
    if(NumberTextBox.value == "" || (NumberTextBox.value.length>1 && NumberTextBox.value==0)){ 
